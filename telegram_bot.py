...
1. ✅ **Нова кнопка "⏱️ Таймер світла"** в меню (рядок 110)
2. ✅ **Функція `format_timer_message()`** (рядки 245-318) - показує:
   - Скільки вже є/немає світло (години, хвилини, секунди)
   - Скільки залишилось до зміни
   - Коли буде наступна зміна
   - Коли буде зміна після наступної
3. ✅ **Функція `get_next_period()`** (рядки 183-220) - знаходить наступний період
4. ✅ **Команда `/timer`** також працює
...
⏳ Залишилось до відключення:
8 год 11 хв 15 сек

🔴 Наступне відключення:
о 06:30

📅 Потім ввімкнуть о 09:30
   (через 11год 11хв)
